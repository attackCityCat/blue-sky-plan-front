...
var _414=menu.attr("static.js.style")||"";
...
menu.attr("static.js.style",_414);
menu.show();
...
tr.attr("static.js.style",_82f).attr("class",cls);
if(_834){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
...
_b94.attr("static.js.style",_b96);
tip.attr("static.js.style",_b96+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _b96="top:"+pos+"px;";
_b94.attr("static.js.style",_b96);
tip.attr("static.js.style",_b96+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
