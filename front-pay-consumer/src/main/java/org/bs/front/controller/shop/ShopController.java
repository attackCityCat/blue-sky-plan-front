...
public class ShopController {
    ...
    public String queryShopList(ShopBean shop,String queryShop, Model model,Integer typeId,String price,Integer hiId) throws IOException, SolrServerException {
        //返回的参数map
